...
GLMotif::PopupWindow* OwlParameterDialog::createDialog()
{
  WidgetFactory factory;
  GLMotif::PopupWindow* parameterDialogPopup=factory.createPopupWindow("ParameterDialogPopup", "Owl Parameters");
  ...
  currentAValue->setString("10.");

  aParameterSlider=factory.createSlider("AParameterSlider", 15.0);
  aParameterSlider->setValueRange(0.0, 20.0, .01);
  aParameterSlider->setValue(10.);
  aParameterSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);

  factory.createLabel("BParameterLabel", "b");

  currentBValue=factory.createTextField("CurrentBValue", 10);
  currentBValue->setString("10.");

  bParameterSlider=factory.createSlider("BParameterSlider", 15.0);
  bParameterSlider->setValueRange(0.0, 20.0, .01);
  bParameterSlider->setValue(10.);
  bParameterSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);

  factory.createLabel("CParameterLabel", "c");

  currentCValue=factory.createTextField("CurrentCValue", 10);
  currentCValue->setString("13.");

  cParameterSlider=factory.createSlider("CParameterSlider", 15.0);
  cParameterSlider->setValueRange(0.0, 20.0, .01);
  cParameterSlider->setValue(13.);
  cParameterSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);


  factory.createLabel("StepSizeLabel", "step size");
  stepSizeValue=factory.createTextField("StepSizeValue", 10);
  double step_size = IntegrationStepSize::instance()->getSavedValue("Owl");
  ...
  stepSizeSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);
  ...
  exactEvalToggle->getValueChangedCallbacks().add(this, &OwlParameterDialog::evalTogglesCallback);
  gridEvalToggle->getValueChangedCallbacks().add(this, &OwlParameterDialog::evalTogglesCallback);
  ...
  xSpacingSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);
  ...
  ySpacingSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);
  ...
  zSpacingSlider->getValueChangedCallbacks().add(this, &OwlParameterDialog::sliderCallback);
...
void OwlParameterDialog::sliderCallback(GLMotif::Slider::ValueChangedCallbackData* cbData)
{
  ...
  else if (strcmp(cbData->slider->getName(), "StepSizeSlider")==0)
  {
    ...
    IntegrationStepSize::instance()->saveValue("Owl", value);
  }
...
void OwlParameterDialog::evalTogglesCallback(GLMotif::ToggleButton::ValueChangedCallbackData* cbData)
{
