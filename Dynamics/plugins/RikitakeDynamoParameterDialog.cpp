...
void RikitakeDynamoParameterDialog::sliderCallback(GLMotif::Slider::ValueChangedCallbackData* cbData)
{
...
void RikitakeDynamoParameterDialog::evalTogglesCallback(GLMotif::ToggleButton::ValueChangedCallbackData* cbData)
{
