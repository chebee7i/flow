...
GLMotif::PopupWindow* STVFlowParameterDialog::createDialog()
{
  WidgetFactory factory;
  GLMotif::PopupWindow* parameterDialogPopup=factory.createPopupWindow("ParameterDialogPopup", "STVFlow Parameters");
  ...
  alphaParameterSlider->setValue(0.5);
  alphaParameterSlider->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::sliderCallback);
  ...
  betaParameterSlider->setValue(0.5);
  betaParameterSlider->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::sliderCallback);
  ...
  stepSizeSlider->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::sliderCallback);
  ...
  exactEvalToggle->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::evalTogglesCallback);
  gridEvalToggle->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::evalTogglesCallback);
  ...
  xSpacingSlider->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::sliderCallback);
  ...
  ySpacingSlider->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::sliderCallback);
  ...
  zSpacingSlider->getValueChangedCallbacks().add(this, &STVFlowParameterDialog::sliderCallback);
...
void STVFlowParameterDialog::sliderCallback(GLMotif::Slider::ValueChangedCallbackData* cbData)
{
...
void STVFlowParameterDialog::evalTogglesCallback(GLMotif::ToggleButton::ValueChangedCallbackData* cbData)
{
