...
GLMotif::PopupWindow* VallisParameterDialog::createDialog()
{
  WidgetFactory factory;
  GLMotif::PopupWindow* parameterDialogPopup=factory.createPopupWindow("ParameterDialogPopup", "Vallis Parameters");
  ...
  currentUValue->setString("12");

  uParameterSlider=factory.createSlider("UParameterSlider", 15.0);
  uParameterSlider->setValueRange(11, 13, 0.01);
  uParameterSlider->setValue(12);
  uParameterSlider->getValueChangedCallbacks().add(this, &VallisParameterDialog::sliderCallback);

  factory.createLabel("AParameterLabel", "a");

  currentAValue=factory.createTextField("CurrentAValue", 10);
  currentAValue->setString("0.3");

  aParameterSlider=factory.createSlider("AParameterSlider", 15.0);
  aParameterSlider->setValueRange(0.2, 0.4, 0.01);
  aParameterSlider->setValue(0.3);
  aParameterSlider->getValueChangedCallbacks().add(this, &VallisParameterDialog::sliderCallback);


  factory.createLabel("StepSizeLabel", "step size");
  stepSizeValue=factory.createTextField("StepSizeValue", 10);
  double step_size = IntegrationStepSize::instance()->getSavedValue("Vallis");
  ...
  stepSizeSlider->getValueChangedCallbacks().add(this, &VallisParameterDialog::sliderCallback);
  ...
  exactEvalToggle->getValueChangedCallbacks().add(this, &VallisParameterDialog::evalTogglesCallback);
  gridEvalToggle->getValueChangedCallbacks().add(this, &VallisParameterDialog::evalTogglesCallback);
  ...
  xSpacingSlider->getValueChangedCallbacks().add(this, &VallisParameterDialog::sliderCallback);
  ...
  ySpacingSlider->getValueChangedCallbacks().add(this, &VallisParameterDialog::sliderCallback);
  ...
  zSpacingSlider->getValueChangedCallbacks().add(this, &VallisParameterDialog::sliderCallback);
...
void VallisParameterDialog::sliderCallback(GLMotif::Slider::ValueChangedCallbackData* cbData)
{
  ...
  else if (strcmp(cbData->slider->getName(), "StepSizeSlider")==0)
  {
    ...
    IntegrationStepSize::instance()->saveValue("Vallis", value);
  }
...
void VallisParameterDialog::evalTogglesCallback(GLMotif::ToggleButton::ValueChangedCallbackData* cbData)
{
