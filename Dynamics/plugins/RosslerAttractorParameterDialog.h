...
#ifndef ROSSLERATTRACTORPARAMETERDIALOG_H_
#define ROSSLERATTRACTORPARAMETERDIALOG_H_
...
class RosslerAttractorParameterDialog : public CaveDialog
{
...
public:
  RosslerAttractorParameterDialog(GLMotif::PopupMenu *parentMenu, DynamicalModel* m)
     : CaveDialog(parentMenu), model(m)
  {
    dialogWindow=createDialog();
  }

  virtual ~RosslerAttractorParameterDialog() { }
};
