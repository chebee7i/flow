...
#ifndef ABCFLOWPARAMETERDIALOG_H_
#define ABCFLOWPARAMETERDIALOG_H_
...
class ABCFlowParameterDialog : public CaveDialog
{
...
public:
  ABCFlowParameterDialog(GLMotif::PopupMenu *parentMenu, DynamicalModel* m)
     : CaveDialog(parentMenu), model(m)
  {
    dialogWindow=createDialog();
  }

  virtual ~ABCFlowParameterDialog() { }
};
